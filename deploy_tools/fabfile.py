...
REPO_URL = 'https://github.com/alexenko/tdd-todo.git'
SITES_FOLDER = '/home/alexenko/sites'
...
def _update_database(source_folder):
    run('cd %s && ../virtualenv/bin/python3 manage.py syncdb --noinput --migrate' % (source_folder,))
